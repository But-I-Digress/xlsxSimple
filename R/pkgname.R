...
#'
#' \itemize{
#' \item \code{utils::install.packages(file.choose(), INSTALL_opts="--no-multiarch")}
#' \item \code{devtools::install(path, args = "--no-multiarch")}
#' \item \code{devtools::install_github("But-I-Digress/xlsxSimple", args = "--no-multiarch")}
#' }
#'
