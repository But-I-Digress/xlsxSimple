...
.onLoad <- function(libname, pkgname) {
	...
	xlsx.datetime.format <- getOption("xlsx.datetime.format")
	if (is.null(xlsx.datetime.format)) xlsx.datetime.format <- "d MMM yyyy"
	xlsx.date.format <- getOption("xlsx.date.format")
	if (is.null(xlsx.date.format)) xlsx.date.format <- "d MMM yyyy"
